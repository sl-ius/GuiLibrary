...
local Release = "Modified Rayfield"
...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			SliderProgress = Color3.fromRGB(133, 103, 255),
			SliderStroke = Color3.fromRGB(83, 64, 159),

			ToggleBackground = Color3.fromRGB(30, 30, 30),
			ToggleEnabled = Color3.fromRGB(83, 64, 159),
			ToggleDisabled = Color3.fromRGB(100, 100, 100),
			ToggleEnabledStroke = Color3.fromRGB(133, 103, 255),
...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    TabList.Template.UICorner.CornerRadius = UDim.new(0, 10)
