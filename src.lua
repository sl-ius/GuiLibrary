...
if gethui then
	Lynxfield.Parent = gethui()
elseif syn.protect_gui then 
	syn.protect_gui(Lynxfield)
	Lynxfield.Parent = CoreGui
elseif CoreGui:FindFirstChild("RobloxGui") then
	Lynxfield.Parent = CoreGui:FindFirstChild("RobloxGui")
else
	Lynxfield.Parent = CoreGui
end
...
if gethui then
	for _, Interface in ipairs(gethui():GetChildren()) do
		if Interface.Name == Lynxfield.Name and Interface ~= Lynxfield then
			Interface.Enabled = false
			Interface.Name = "Lynxfield-Old"
		end
	end
else
...
function ChangeTheme(ThemeName)
	SelectedTheme = LynxfieldLibrary.Theme[ThemeName]
...
function LynxfieldLibrary:CreateWindow(Settings)
	...
	pcall(function()
		...
		if not isfolder(LynxfieldFolder.."/".."Configuration Folders") then
	...
	if Settings.KeySystem then
		...
		if isfile(LynxfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
			for _, MKey in ipairs(Settings.KeySettings.Key) do
				if string.find(readfile(LynxfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension), MKey) then
					Passthrough = true
				end
			end
		end
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				...
				if KeyFound then 
					...
					if Settings.KeySettings.SaveKey then
						if writefile then
							writefile(LynxfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension, FoundKey)
						end
...
task.delay(3.5, LynxfieldLibrary.LoadConfiguration, LynxfieldLibrary)
